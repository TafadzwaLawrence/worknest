...
import { OffboardingTemplateTask } from './offboarding-template-task.entity';
import { TaskStatus, PriorityLevel } from '../onboarding.enums';

@Entity('offboarding_case_tasks')
export class OffboardingCaseTask {
  ...
  @ManyToOne(() => OffboardingTemplateTask, { nullable: true, onDelete: 'SET NULL' })
  @JoinColumn({ name: 'template_task_id' })
  templateTask: OffboardingTemplateTask | null;
