...
ALTER TABLE onboarding_case_tasks       ENABLE ROW LEVEL SECURITY;
ALTER TABLE offboarding_cases           ENABLE ROW LEVEL SECURITY;
ALTER TABLE offboarding_case_tasks      ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE knowledge_transfer_records  ENABLE ROW LEVEL SECURITY;
ALTER TABLE clearance_checklist_items   ENABLE ROW LEVEL SECURITY;
ALTER TABLE onboarding_notes            ENABLE ROW LEVEL SECURITY;
ALTER TABLE offboarding_notes           ENABLE ROW LEVEL SECURITY;

CREATE POLICY tenant_isolation ON onboarding_templates       USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON onboarding_template_tasks  USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON offboarding_templates      USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON offboarding_template_tasks USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON onboarding_cases           USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON onboarding_case_tasks      USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON offboarding_cases          USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON offboarding_case_tasks     USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON provisioning_requests      USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON asset_assignments          USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON exit_interviews            USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON knowledge_transfer_records USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON clearance_checklist_items  USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON onboarding_notes           USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
CREATE POLICY tenant_isolation ON offboarding_notes          USING (tenant_id = current_setting('app.current_tenant_id', true)::UUID);
