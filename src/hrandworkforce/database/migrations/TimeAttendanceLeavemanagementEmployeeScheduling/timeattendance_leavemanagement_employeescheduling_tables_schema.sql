...
CREATE TABLE shift_templates (
    ...
    duration INTERVAL GENERATED ALWAYS AS (
        CASE WHEN end_time >= start_time
             ...
             ELSE ((end_time + TIME '24:00') - start_time)
        END
    ) STORED,
...
CREATE TRIGGER update_employee_emergency_contacts_updated_at BEFORE UPDATE ON employee_emergency_contacts FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
